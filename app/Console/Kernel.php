...
use App\Console\Commands\EmailCumpleaniosConductores;
...
class Kernel extends ConsoleKernel
{
    ...
    protected $commands = [
        ...
        EmailCumpleaniosConductores::class,
    ...
    {
        $schedule->command('trabajador:cumpleanios')->dailyAt('05:00');
        $schedule->command('conductor:cumpleanios')->dailyAt('05:40');
