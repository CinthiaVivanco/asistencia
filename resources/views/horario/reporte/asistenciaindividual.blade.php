          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="panel panel-default panel-table">
                ...
                <div class="panel-heading">Asistencia Individual
                  <div class="tools tooltiptop">


                    <a href="{{url('/asistencia-individual-trabajador-fechas-excel')}}" 
                       class='tooltipcss'
                       target="_blank"
                       id="descargarasistenciaindividuallexcel" 
                       data-href="{{url('/asistencia-individual-trabajador-fechas-excel')}}"
                       title="Descargar asistencia individual">
                       <span class="tooltiptext">Descargar Asistencia Individual</span>
                       <i class="fa fa-file-excel-o"></i>
                    </a>

                    <a href="#" class="tooltipcss" id='buscarreporteasistenciaindividual' >
                ...
                <div class="panel-body selectfiltro">
                  ...
                  <div class="col-xs-12">
                    <div class='listaasistenciadiaria listajax reporteajax'>
                        <div class='ajaxvacio'>
                          Seleccione una trabajador y fechas correspondientes ...
