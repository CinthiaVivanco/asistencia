          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="panel panel-default panel-table">
                ...
                <div class="panel-heading">Asistencia Diaria
                  <div class="tools tooltiptop">


                    <a href="{{url('/horario-empresa-fecha-excel')}}" 
                       class='tooltipcss'
                       target="_blank"
                       id="descargarasistenciaexcel" 
                       data-href="{{url('/horario-empresa-fecha-excel')}}"
                       title="Descargar asistencia diaria">
                       <span class="tooltiptext">Descargar Asistencia Diaria</span>
                       <i class="fa fa-file-excel-o"></i>
                    </a>

                    <a href="#" class="tooltipcss" id='buscarreporteasistenciadiaria' >
