          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="panel panel-default panel-table">
                ...
                <div class="panel-heading">Asistencia Diaria Mintra
                  <div class="tools tooltiptop">


                    <a href="{{url('/horario-mintra-empresa-fecha-pdf')}}" 
                       target="_blank" 
                       data-toggle="tooltip" 
                       id="descargarasistenciamintrapdf" 
                       data-placement="top" 
                       data-href="{{url('/horario-mintra-empresa-fecha-pdf')}}"
                       title="Descargar asistencia diaria">
                        <span class="icon mdi mdi-collection-pdf"></span>
                    </a>


                    <a href="{{url('/horario-mintra-empresa-fecha-excel')}}" 
                       class='tooltipcss'
                       target="_blank"
                       id="descargarasistenciamintraexcel" 
                       data-href="{{url('/horario-mintra-empresa-fecha-excel')}}"
                       title="Descargar asistencia diaria">
                       <span class="tooltiptext">Descargar Asistencia Diaria Mintra</span>
                       <i class="fa fa-file-excel-o"></i>
                    </a>

                    <a href="#" class="tooltipcss" id='buscarreporteasistenciadiariamintra' >
                      <span class="tooltiptext">Buscar Asistencia Mintra</span>
                ...
                <div class="panel-body selectfiltro">
                  ...
                  <div class="col-xs-12">
                    <div class='listaasistenciadiaria listajax reporteajax'>
                        <div class='ajaxvacio'>
                          Seleccione una empresa y fecha ...
