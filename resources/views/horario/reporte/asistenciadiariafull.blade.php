          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="panel panel-default panel-table">
                ...
                <div class="panel-heading">Asistencia Diaria Full
                  <div class="tools tooltiptop">


                    <a href="{{url('/horario-full-empresa-fecha-excel')}}" 
                       class='tooltipcss'
                       target="_blank"
                       id="descargarasistenciafullexcel" 
                       data-href="{{url('/horario-full-empresa-fecha-excel')}}"
                       title="Descargar asistencia diaria full">
                       <span class="tooltiptext">Descargar Asistencia Diaria Full</span>
                       <i class="fa fa-file-excel-o"></i>
                    </a>

                    <a href="#" class="tooltipcss" id='buscarreporteasistenciadiariafull' >
                      <span class="tooltiptext">Buscar Asistencia Full</span>
