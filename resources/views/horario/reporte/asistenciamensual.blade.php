          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="panel panel-default panel-table">
                ...
                <div class="panel-heading">Asistencia Mensual
                  <div class="tools tooltiptop">


                    <a href="{{url('/asistencia-mensual-trabajador-fechas-excel')}}" 
                       class='tooltipcss'
                       target="_blank"
                       id="descargarasistenciamensuallexcel" 
                       data-href="{{url('/asistencia-mensual-trabajador-fechas-excel')}}"
                       title="Descargar asistencia mensual">
                       <span class="tooltiptext">Descargar Asistencia Mensual</span>
                       <i class="fa fa-file-excel-o"></i>
                    </a>

                    <a href="#" class="tooltipcss" id='buscarreporteasistenciamensual' >
